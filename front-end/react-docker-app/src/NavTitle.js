...
export default props => ( 
    <nav className="flex items-center flex-wrap bg-orange-600 lg:px-20 py-2 pl-5 pr-5">
        <div className="lg:hidden bg-orange-600 pr-4">
        ...
        <div className="object right">
            <button className="px-2 py-2 border rounded text-orange-200 border-orange-600 hover:text-white hover:border-white heroicon-ui">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><title>Cart</title><path  fill="white" d="M17 16a3 3 0 1 1-2.83 2H9.83a3 3 0 1 1-5.62-.1A3 3 0 0 1 5 12V4H3a1 1 0 1 1 0-2h3a1 1 0 0 1 1 1v1h14a1 1 0 0 1 .9 1.45l-4 8a1 1 0 0 1-.9.55H5a1 1 0 0 0 0 2h12zM7 12h9.38l3-6H7v6zm0 8a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm10 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"/></svg>
            </button>
            <Link to={'/signinpage'}>
                <button className="px-2 py-2 border rounded text-orange-200 border-orange-600 hover:text-white hover:border-white heroicon-ui">
