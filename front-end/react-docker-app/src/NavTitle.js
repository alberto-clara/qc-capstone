...
const NavTitle = (props)=> {
    ...
    if (stateNav != null || state.user.hasOwnProperty("user")) {
        ...
        buttonManage = (<Fragment>
            <Link to={'/manageuser'}>
                <button className="NavTitle_Icons" alt="button">
    ...
    return (
        <nav className="NavTitle_Background">
            ...
            <div>
                <div className="text-white rounded-full text-center text-xl style fade-in"> {countItem}</div>
                <Link to={'/cart'}>
                    <button onClick={() => { if (props.location.pathname === "/cart") window.location.href = '/cart'; }} className="NavTitle_Icons" alt="button">
