...
export default props => ( 
    <nav class="flex flex-wrap bg-orange-600 lg:px-20 py-2 pl-5 pr-5">
        ...
        <div class="flex-1 text-white mr-6 lg:pl-0 sm:pl-6">
            <Link to={'/'}>
                <span class="font-bold lg:text-3xl sm:text-xl">Quote Center</span>
            </Link>
        </div>
        <div>
            ...
            <Link to={'/signinpage'}>
                <button class="px-2 py-2 border rounded text-orange-200 border-orange-600 hover:text-white hover:border-white">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><title>Account</title><path class="heroicon-ui" fill="white" d="M12 12a5 5 0 1 1 0-10 5 5 0 0 1 0 10zm0-2a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm9 11a1 1 0 0 1-2 0v-2a3 3 0 0 0-3-3H8a3 3 0 0 0-3 3v2a1 1 0 0 1-2 0v-2a5 5 0 0 1 5-5h8a5 5 0 0 1 5 5v2z"/></svg>
                </button>
            </Link>
        </div>
    </nav>
