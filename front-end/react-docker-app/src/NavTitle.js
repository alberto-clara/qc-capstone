...
export default props => ( 
    <nav className="flex flex-wrap bg-orange-600 lg:px-20 py-2 pl-5 pr-5">
        ...
        <div>
            <button className="px-2 py-2 border rounded text-orange-200 border-orange-600 hover:text-white hover:border-white">
